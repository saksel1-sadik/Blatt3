...
public class H2_main {
	...
	public static void main(String[] args) {
		...
		int jahr = 2025;   //jahr stets >= 0 , nicht negativ
		 ...
		 * Ein Jahr ist ein Schaltjahr, falls die Jahreszahl durch 4 teilbar ist, 
		 * außer, 
		 * es ist ein Jahr, das durch 100 teilbar ist. 
		 * 
		 * Ausnahmen sind in diesem Fall aber wiederum Jahre, 
		 * die durch 400 teilbar sind: das sind dann wieder Schaltjahre.
		 */
